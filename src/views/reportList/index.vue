        ...
        <el-card class="box-card">
            <div class="top-box">
                <el-form ref="queryFormRef" :model="queryParams" :inline="true">
                    <el-form-item label="创建时间" prop="">
                        <el-date-picker v-model="queryParams.date" type="daterange" size="small" range-separator="至"
            ...
            <div style="border-radius: 0px">
                <el-row :gutter="20">
                    <el-col :span="6">
                        <div>
                            <el-statistic title="报告数" :value="totalData.nReport">
                            </el-statistic>
                        </div>
                    </el-col>
                </el-row>
...
<script>
import { QueryQuestionnaire, QueryTotal,GetCityCounty } from '@/api';
export default {
    name: 'exploreList',
    data() {
        return {
